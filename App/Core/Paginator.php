...
class Paginator
{
    ...
    public function page_links($path = '?', $ext = null)
    {
        ...
        if ($lastpage > 1) {
            ...
            if ($this->_page > 1)
                $pagination .= "<li class='page-item'><a class='page-link page-prev' href='" . $path . "$this->_instance=$prev" . "$ext'><i class='fas fa-chevron-left'></i></a></li>";
            else
                $pagination .= "<li class='page-item disabled'><a class='page-link page-prev'><i class='fas fa-chevron-left'></i></a></li>";
            ...
            if ($this->_page < $counter - 1)
                $pagination .= "<li class='page-item'><a class='page-link page-next' href='" . $path . "$this->_instance=$next" . "$ext'><i class='fas fa-chevron-right'></i></a></li>";
            else
                $pagination .= "<li class='page-item disabled'><span class='page-link page-next'><i class='fas fa-chevron-right'></i></span></li>";
            $pagination .= "</ul>\n";
        }
